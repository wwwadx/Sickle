...
class ORIGINAL_BID1(FactorBase):
    def __init__(self, frequency):
        super(ORIGINAL_BID1, self).__init__(frequency)
    ...
    def compute(self, start_date=None, end_date=None):
        ...
        for contract in self.contracts:
            ...
            temp = self.api.market_data(table_name, 'datetime,bid_price_1', start_date, end_date)
            if len(temp) > 0:
                temp = temp.rename(columns={'bid_price_1': contract})
